...
app.post('/removeuser',function(req,res){
  ...
  console.log(req.body.input_emp_id);

  
    
    user.findOne({employee_Id: req.body.input_emp_id }, function (err, docs) {
      if (err){
          req.flash()
          console.log("error1")
      }
        ...
        let transporter = nodemailer.createTransport({
          service:"gmail",
          auth:{
            user: "josepharyan96@gmail.com",
            pass:"8895744916"
          }

        });
        let mailOptions ={
          from:"josepharyan96@gmail.com",
          to:docs.email,
          subject: "Removing of user",
    ...
    user.findOneAndDelete({employee_Id: req.body.input_emp_id},(err)=>{
      if(err){
        console.log(err)
